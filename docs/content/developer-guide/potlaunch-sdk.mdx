...
import {
  ...
  getAppConfig
} from '@cookedbusiness/halfbaked-sdk';
...
// App-specific presets (Cooked, Arrests, PotLaunch, Generic)
...
```typescript
import { HalfBakedLiquidityManager, type SDKConfig } from '@cookedbusiness/halfbaked-sdk';
...
```typescript
import { SwapKitManager } from '@cookedbusiness/halfbaked-sdk';
...
```typescript
import { HalfBakedSDK } from '@cookedbusiness/halfbaked-sdk';
import { Connection, Keypair } from '@solana/web3.js';

const connection = new Connection('https://api.mainnet-beta.solana.com');
const wallet = Keypair.generate(); // Or use your existing wallet

const sdk = new HalfBakedSDK({
  connection,
  wallet,
  environment: 'mainnet'
});
...
The HalfBaked SDK is designed to work seamlessly in both browser and server environments.
...
- Report bugs and feature requests on [GitHub Issues](https://github.com/cookedlabs/halfbaked-sdk/issues)
