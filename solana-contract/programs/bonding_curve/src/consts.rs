...
pub const QUOTE_TOKEN_MINT: &str = "So11111111111111111111111111111111111111112";

pub const PUMP_SWAP_PROGRAM_KEY: &str = "pAMMBay6oceH9fJKBRHGP5D4bD4sWpmSwMn52FMfXEA";
