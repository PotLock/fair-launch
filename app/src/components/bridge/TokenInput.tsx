        ...
        <>
            <div className="flex justify-between items-center">
                <input
                    ...
                    className={`text-2xl font-semibold border-none outline-none bg-transparent w-64 ${isReadOnly ? 'text-gray-400' : ''}`}
                    ...
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <span className="inline-block">
                                <Button
                                    variant="outline"
                                    className="bg-gray-50 hover:bg-gray-100 disabled:bg-gray-100 disabled:cursor-not-allowed border border-gray-200 hover:text-black cursor-pointer shadow-none"
            ...
            <div className="flex justify-between items-center mt-2">
                ...
                <div className="flex items-center gap-2">
                    ...
                    {isReadOnly ? (
                        <>
                            <button className="h-5 px-3 text-xs border border-gray-200 rounded" disabled>
                                50%
                            </button>
                            <button className="h-5 px-3 text-xs border border-gray-200 rounded" disabled>
                                Max
                        ...
                        <>
                            <button
                                className="h-5 px-3 text-xs cursor-pointer hover:border-red-500 hover:text-red-500 border border-gray-200 rounded-sm disabled:cursor-not-allowed disabled:bg-gray-100 disabled:text-gray-400 disabled:border-gray-200"
