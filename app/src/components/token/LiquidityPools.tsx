            ...
            <div className="flex items-center justify-between mb-3">
                        ...
                        <div className="flex items-center gap-1 mt-1">
                            {pool.platforms.map((platform, index) => (
                                <div key={index} className="flex items-center gap-1 border border-neutral-200 p-1 px-2 justify-center bg-neutral-50 rounded-full">
                                    <img src={platform.platformIcon} alt={platform.platform} className="w-4 h-4" />
                ...
                <div className="flex items-center gap-2">
                    <Button  
                        ...
                        size="sm" 
                        className="text-xs bg-white border border-gray-200 hover:bg-gray-50 hover:border-gray-300 shadow-none cursor-pointer"
                    >
                        View on Meteora
